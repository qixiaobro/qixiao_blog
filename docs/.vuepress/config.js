...
module.exports = {
  ...
  themeConfig: {
    ...
    repo: "https://github.com/qixiaobro", // 导航栏右侧生成Github链接
    ...
    author: {
      ...
      name: "QiXiao", // 必需
      link: "https://github.com/qixiaobro", // 可选的
    },
    blogger: {
      // 博主信息，显示在首页侧边栏
      avatar:
        "https://avatars3.githubusercontent.com/u/34623348?s=460&u=4faff092a9ccc8e925566b416bef5597f209d319&v=4",
      name: "QiXiao",
      slogan: "少抱怨，多思考，未来更美好。",
    },
    social: {
      // 社交图标，显示于博主信息栏和页脚栏
    ...
    footer: {
      ...
      copyrightInfo:
        '<a href="https://beian.miit.gov.cn/" target="_self">QiXiao| 闽ICP备20003477号-1</a>', // 博客版权信息，支持a标签
    },
  },
  plugins: [
    // 插件
    ...
    [
      "demo-block",
      {
        ...
        settings: {
          ...
          vue: "https://unpkg.com/vue@next", // 在线示例中的vue依赖
    ...
    [
      ...
      // },
      {
        ...
        options: {
          ...
          clientSecret: "06a275700bddd003d1a547fa90927292e80edaaa",
          repo: "blog-gitalk-comment", // GitHub 仓库
          owner: "qixiaobro", // GitHub仓库所有者
          admin: ["qixiaobro"], // 对仓库有写权限的人
